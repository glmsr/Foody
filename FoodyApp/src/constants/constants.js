const onboarding_screens = [
    {
        ...
        description: "When you order Eat Street, we’ll hook you up with exclusive coupon, specials and rewards"
    },
    {
        id: 2,
...
const bottom_tabs = [
    { id: 0, label: screens.home },
    { id: 1, label: screens.search },
    { id: 2, label: screens.cart },
    { id: 3, label: screens.favourite },
    { id: 4, label: screens.notification },
]
...
const track_order_status = [
    ...
    { id: 4, title: "Delivered", sub_title: "Enjoy your meal!" },
